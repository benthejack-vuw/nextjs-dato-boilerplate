...
import type { RootLevelPageBySlugQuery } from "@catalyst/types/dato/graphql";
...
type LiveUpdatesProps = {
	query: TypedDocumentNode<RootLevelPageBySlugQuery, { slug: string }>;
	variables: { slug: string };
	initialData: RootLevelPageBySlugQuery;
};

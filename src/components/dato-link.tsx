...
import { isExternalLinkBlock, isInternalLinkBlock, linkHref } from "@/lib/dato/link-utils";
...
>(({ slug, children, className, ...anchorProps }, ref) => {
	return (
		<a href={slug} rel="noopener noreferrer" target="_blank" className={className} ref={ref} {...anchorProps}>
			{children}
		</a>
	);
});
